 ...
 * Date: 14e Juni
 * 
 * This file allows the Admin's to shows/controls all user. In this file the admin can see the whole users lists, delete or promote a user and see user purchases 
