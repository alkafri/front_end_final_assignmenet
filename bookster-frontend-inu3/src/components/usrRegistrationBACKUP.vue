        ...
        registerUser() {
            ...
            .then(data => {
                ...
                if (data.message === "Account successfully created") {
                    ...
                    const expirationTime = new Date().getTime() + 45 * 60 * 1000; // 45 minutes
                    ...
                    // Start a timer to automatically remove the token after expiration
                    const tokenExpirationTimer = setTimeout(() => {
                        this.logoutUser();
                    }, 45 * 60 * 1000);
                    localStorage.setItem('tokenExpirationTimer', tokenExpirationTimer.toString());
