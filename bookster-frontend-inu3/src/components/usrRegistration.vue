 ...
 * Date: 14e Juni
 * 
 * This file contains the Template, Script, Styles, for "New user registration form", It handles the inputs (username , password), and register the new user
 * Note: the new user registration is valid ONLY during the current session, once the session close, the new user will be deleted automatically.
 */
